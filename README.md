...
### **12 Claude Skills + 4 Slash Commands for Ableton Live producers**
### Music-theory grounded co-pilot workflows for Claude Code, Cursor, Codex, and Gemini CLI
...
[![Made by Glincker](https://img.shields.io/badge/made%20by-Glincker-black)](https://github.com/glincker)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)
[![Stars](https://img.shields.io/github/stars/glincker/ableton-skills?style=social)](https://github.com/glincker/ableton-skills)

[**Quick install**](#-quick-install) • [**Skills**](#-the-12-skills) • [**Commands**](#-slash-commands) • [**Why this exists**](#-why-this-exists) • [**FAQ**](#-faq) • [**Contributing**](CONTRIBUTING.md)
...
Generic Claude knows music theory but doesn't know:

- That you should high-pass your pads at 100 Hz to clean up mud
- That voice leading on a string ensemble must respect Vln1's range (G3-G6)
- That kick-bass masking at 80 Hz is the #1 cause of "muddy mix"
- That a lo-fi hi-hat needs ±15 velocity, ±8 ms, and 8-12% swing to feel right
- That a trap beat at 140 BPM is half-time, not slow

**`ableton-skills` is the missing prompt-engineering layer** — production-grade Claude/Cursor skills that turn a generic AI into a music-theory-aware co-producer.

### Co-pilot, not generator

We do **not** compete with Suno, Udio, or AIVA. The user owns the melody, the emotion, and the structure. We handle the mechanical translation tax: track scaffolding, voice leading, velocity curves, mix diagnostics, MIDI cleanup, articulation choices, DAW navigation.

---

## 📊 How we compare

| | `ableton-skills` | Generic Claude | Original `ahujasid/ableton-mcp` | `uisato/ableton-mcp-extended` |
| --- | :---: | :---: | :---: | :---: |
| MCP server included | — | — | ✅ | ✅ |
| Producer-aware skills | **✅** | ❌ | ❌ | ❌ |
| Music-theory voice leading | **✅** | partial | ❌ | ❌ |
| Mix diagnostic workflow | **✅** | ❌ | ❌ | ❌ |
| MIDI humanization | **✅** | ❌ | ❌ | ❌ |
| Genre-aware drum patterns | **✅** | partial | ❌ | ❌ |
| Slash commands | **✅** | ❌ | ❌ | ❌ |
| CLAUDE.md drop-in | **✅** | ❌ | ❌ | ❌ |
| Multi-platform | **✅ (4)** | n/a | Claude only | Claude + Cursor |
| Active maintenance | **✅** | n/a | ❌ (3 PRs merged in 50) | ✅ |
...
| 10 | [**`sidechain-setup`**](skills/sidechain-setup/SKILL.md) | Sidechain compression routing kick→bass, vocal→bed |
...
[demo gif placeholder — record one of `producer-mode` from prompt to populated session]
...
<details>
<summary><b>What if I don't have third-party plugins like Spitfire / Serum?</b></summary>

Every skill defaults to **stock Ableton** instruments and effects (Operator, Wavetable, Analog, Drift, EQ Eight, Compressor, Glue, Limiter). If a skill mentions a third-party plugin, it's optional and the skill falls back to stock.
</details>
...
<details>
<summary><b>Why is the "12+" claim accurate?</b></summary>

12 skills shipped in v0.1.0, with weekly skill additions on the roadmap. Check `skills/` for the current count.
</details>

<details>
<summary><b>What's the difference between this and `awesome-claude-skills` lists?</b></summary>

Awesome lists are curation. We're a focused **production-grade skill bundle for one domain (music production in Ableton)**. We test skills against a real MCP server, follow a consistent format, and merge contributor PRs. Awesome lists link to skills; we ship skills.
</details>
...
| --- | --- | --- |
| `uisato/ableton-mcp-extended` | ✅ | Recommended. Most tools mapped. |
| `ahujasid/ableton-mcp` | ⚠️ | Works for `producer-mode`, `midi-cleanup`. Limited for advanced skills. |
| `jpoindexter/ableton-mcp` | ⚠️ | 200+ tools but less actively maintained. |
| Custom / local fork | 🔄 | If your fork follows the standard tool naming, skills should work. Open an issue if not. |

| AI assistant | Tested | Skill format |
| --- | --- | --- |
| Claude Code | ✅ | `~/.claude/skills/` |
| Cursor | ✅ | `.cursor/rules/` |
| Codex CLI | ✅ | Reference via `AGENTS.md` |
| Gemini CLI | ✅ | Reference via `GEMINI.md` |
| Continue.dev | 🔄 | Untested but should work |
| Aider | 🔄 | Untested |
...
- @hidingwill (PR #66, #69-71 — 230+ tools work)
...
[Issues](https://github.com/glincker/ableton-skills/issues) • [Discussions](https://github.com/glincker/ableton-skills/discussions) • [Twitter](https://twitter.com/glincker)
